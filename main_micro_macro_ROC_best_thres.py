...
#plot_model(export_model, show_shapes=True,show_dtype=False,show_layer_names=False,show_layer_activations=True,expand_nested=True,to_file="mymodel.png")
...
plt.scatter(fpr["micro"][ix], tpr["micro"][ix], marker='o', color='black', label='Best')
plt.plot(
    fpr["macro"],
    tpr["macro"],
